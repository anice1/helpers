...
def scatter(x, y, title, xlabel, ylabel, legend):
    plt.scatter(x, y)
    plt.title(title)
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
...
def violin( x, title, xlabel, ylabel):
    """
...
def plot_lr_vs_loss(learning_rate, history):
    """
